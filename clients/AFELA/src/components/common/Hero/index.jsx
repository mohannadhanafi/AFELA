...
export default class Hero extends Component {
  ...
  componentDidMount() {
    axios('/api/v1/heading').then((result) => {
      const { data } = result;
                ...
                <div className="col-md-7 ">
                  <article className="post-1">
                    <div className="entry-img hover-scale">
                      <img className="hero1" src={`/api/v1/getFile/${hero[0].header_media[0]}`} alt="bg-slider" />
                ...
                <div className="col-md-5 ">
                  {hero[1] ? (
                    <article className="post-2">
                      <div className="entry-img hover-scale">
                        <img className="hero2" src={`/api/v1/getFile/${hero[1].header_media[0]}`} alt="" />
                    ...
                    <div className="row small-spacing">
                      {hero.slice(2, 4).map(post => (
                        <div className="col-sm-6 post-3">
                          <article>
                            <div className="entry-img hover-scale">
                              <img className="hero3" src={`/api/v1/getFile/${post.header_media[0]}`} alt="bg" />
                              <div className="entry-inner small">
                                <div className="entry">
                                  <h2 className="entry-title color-white">
                                    {post.title}
